...
//                }
    ...
    var Upload = {
        ...
        uploadTpl: '<div class="edui-image-upload%%">' +
            ...
            '<input type="hidden" name="wjlx" value="showImg"/>'+
            '</form>' +
            '</div>',
        ...
        uploadComplete: function(r){
            ...
            try{
                var json = eval('('+r+')');
                console.log(json);
                Base.callback(me.editor, me.dialog, json.attachPath, json.hasErrors);
            }catch (e){
                var lang = me.editor.getLang('image');
                Base.callback(me.editor, me.dialog, '', (lang && lang.uploadError) || 'Error!'||'false');
            }
        },
